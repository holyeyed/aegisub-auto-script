...
script_name = tr"Effect 026W Ngôi sao quay cuồng chữ tím"
...
function add_effect(subs, sel)
	...
	cstyle={{"Default","UVN Ben Xuan",60,"&H00FF0075","&H00FF8100","&H00FFFFFF","&H00000000",false,false,false,false,100,100,0,0,1,2,0,5,10,10,10,1}}
	cdiag={{1,"0:00:00.00","0:00:00.00","Default","",0,0,0,"template noblank","!retime(\"start2syl\",-150,-25)!{\\an5\\pos($scenter,$smiddle)\\fry90\\t(0,250,\\fry0)}"},{0,"0:00:00.00","0:00:00.00","Default","",0,0,0,"template noblank notext","!retime(\"syl\",100,1000)!{\\an5\\fad(0,400)\\1a&HFF&\\3c&H00E4FF&\\bord5\\blur3\\shad0\\pos($scenter,$smiddle)\\frz0\\fscx0\\fscy0\\t(0,100,\\fscx80\\fscy80)\\t(0,5000,\\frz1000)\\fad(0,200)\\p1}m 25 0 l 34 15 l 50 19 l 40 33 l 41 49 l 25 43 l 11 50 l 11 33 l 0 21 l 15 15 l 25 0 \""},{0,"0:00:00.00","0:00:00.00","Default","",0,0,0,"template noblank notext loop 4","!retime(\"syl\",100,1000)!{\\an5\\fad(0,400)\\fscx20\\fscy20\\c&HFFFFFF&\\3c&HFFFFFF&\\c&HFFFFFF&\\bord5\\blur10\\shad0\\move($scenter,$smiddle,!$scenter+math.random(-100,100)!,!$smiddle+math.random(-70,70)!\\fad(0,200)}{\\p1}m 3 3 b 6 -1 13 -1 17 3 b 20 7 20 13 17 17 b 14 21 6 21 3 17 b 0 13 0 7 3 3 \""},{0,"0:00:00.00","0:00:00.00","Default","",0,0,0,"template noblank notext loop 2","!retime(\"syl\",100,1000)!{\\an5\\fad(0,400)\\fscx25\\fscy25\\c&HFFFFFF&\\3c&HFFFFFF&\\c&HFFFFFF&\\bord5\\blur10\\shad0\\move($scenter,$smiddle,!$scenter+math.random(-100,100)!,!$smiddle+math.random(-70,70)!\\fad(0,200)}{\\p1}m 25 0 l 34 15 l 50 19 l 40 33 l 41 49 l 25 43 l 11 50 l 11 33 l 0 21 l 15 15 l 25 0 \""},{0,"0:00:00.00","0:00:00.00","Default","",0,0,0,"template noblank","!retime(\"syl\",-25,300)!{\\an5\\pos($center,$middle)\\bord2\\t(0,25,\\fscx150\\fscy150\\3c&HFFFFFF&\\1c&HFFFFFF&)\\t(25,$dur,\\fscx100\\fscy100\\3c&HFFFFFF&\\1c!line.styleref.color1!)\\fad(0,300)}"}}
	local pinfo=0
	local pstyle=0
	local pdiag=0
	local sl=nil
