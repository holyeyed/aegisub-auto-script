...
nol=math.random(25,30)
t=math.random(5000,10000)
for i=1,nol do
...
subs[0]=l
t=t+tonumber(text_time[1])+math.random(200,2000)
end
end

function makesen()
word={"tôi","bạn","yêu","hoa","lá","mặt","trái","sống","cười","nói","học cách","mong","đi","chạy","mãi","bạn","là","anh","cô","đau","giận","buồn"}
