...
script_name = tr"Effect 008 một dòng màu hồng kí tự tan rã"
script_description = tr"Hiệu ứng karaoke, 1 dòng, màu hồng, kí tự bay tan rã"
...
function add_effect(subs, sel)
	...
	subs.insert(2,E)
	--//-------------------------
	E.text="!retime(\"syl\",0,($ldur-$send)/2)!{\\move($sx,$sy,!$sx-50!,!$sy-math.random(-100,100)!,!$sdur/cc*count()!,$dur)\\t(\\1c&H7aa0ff&\\frz!math.random(180,720)!\\alpha100)}"
